...
Наследование: Расширяет базовый каркас default.html, убирая все дубликаты HTML.
Геометрия: Принудительно расширяет контентный wrapper до 1000px для широкой сетки.
=============================================================================
{% endcomment %}
...
<style>
    ...
    /* КРИТИЧЕСКИЙ ФИКС ГЕОМЕТРИИ: Расширяем базовый контейнер default-шаблона */
    .content-wrapper {
...
{% comment %} 
  УНИКАЛЬНАЯ ШАПКА ГЛАВНОЙ СТРАНИЦЫ
  Заголовки и аватар выводятся внутри контента default-каркаса
{% endcomment %}
<header style="margin-bottom: 10px !important;">
    <img src="/assets/icons/logo.svg" alt="Логотип" class="main-avatar">
</header>

{% comment %} Вывод сетки карточек блоков из файла index.md {% endcomment %}
{{ content }}

{% comment %} Уникальная кнопка Telegram в подвале контента {% endcomment %}
<footer class="main-footer" style="margin-top: 30px; text-align: center; width: 100%;">
