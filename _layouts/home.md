...
<head>
    ...
    <style>
        /* ==========================================================================
           СТИЛИ ТОЛЬКО ДЛЯ ГЛАВНОЙ СТРАНИЦЫ (ОРИГИНАЛ)
           ========================================================================== */
        .grid-container {
            display: grid;
...
<body>
    ...
    {% comment %} 
      УДАЛЕНО: Вызов {% include footer.liquid %} убран отсюда, 
      так как он дублировал системные скрипты, уже вшитые в default-шаблон.
    {% endcomment %}
