---
about: Шаблон для базовых страниц сайт.
purpose: Отображение конечных страниц контента (описания проектов, заметки, учебные статьи). Автоматически наследует навигацию и подвал от шаблона default.md. Возвращает на место блоки тегов, библиографии, источников и логику видео-плееров.
layout: default
custom_css: ["/assets/css/giscus.css", "/assets/css/iframe.css"]
---
...
<!-- ПОДКЛЮЧЕНИЕ ГЛОБАЛЬНОЙ ЛОГИКИ ЛЕЗИ-ЛОАДА МЕДИАКОНТЕНТА -->
{%- include media-logic.liquid -%}
