---
workflow: "в ленете новостей разделить на синюю коемку а разделам типа ярмарки зеленую по цвету вкладок"
layout: default
...
permalink: /engineers/
emoji: "💥"
keywords: [юный инженер, младший инженер, младший конструктор, инженерные работы]
---
