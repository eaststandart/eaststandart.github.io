...
Если во время отскока контакт на миг полностью пропадает, то почему напряжение на графике (второе видео) не падает до самого нуля? Что мешает ему это сделать? Напиши свою инженерную версию в комментариях!
