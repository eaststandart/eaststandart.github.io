...
Ниже представлены видео работы устройства без схемы синхронизации и с ней. Из первого ролика видно, что время зажигания светодиода больше времени его гашения. На втором ролике длительность зажигания и гашения светодиода одинаковы.
...
❓🧠 **Вопрос для размышления:** Если во время отскока контакт на миг полностью пропадает, то почему напряжение на графике не падает до самого нуля  (второе видео)? Что мешает ему это сделать? **Напиши свою инженерную версию в комментариях!**
...
> ⚠️ **Примечание:** Описание работы адаптировано для понимания ребятами 10–14 лет. Намеренно убраны сложные профессиональные термины, скрытые детали и допущены некоторые упрощения, чтобы суть процессов была максимально понятна.
