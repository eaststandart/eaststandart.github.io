...
(function() {
  document.addEventListener("DOMContentLoaded", function() {
    // Находим все контейнеры управления пагинацией на странице
    var controlDivs = document.querySelectorAll('.pagination-controls');
    
    controlDivs.forEach(function(controls) {
      // Считываем входные параметры, бережно заложенные Liquid-шаблоном в дата-атрибуты
      ...
      // Проверяем физическое наличие целевого списка на странице
      ...
      // Первичный пуск отрисовки для текущего контейнера
      renderPage(currentPage);
    });
  });
})();
