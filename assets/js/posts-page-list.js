...
function runMediaArchiveFilter() {
    ...
    allEntries.forEach(function(item) {
      ...
      if (project) {
        ...
        // Режим общей страницы (без параметров): показываем все посты сайта
    ...
    // ШАГ 3: Принудительно запускаем оба раздельных скрипта ленивой загрузки для оставшегося на экране поста
    if (typeof runImageLazyLoad === 'function') {
        runImageLazyLoad();
    }
