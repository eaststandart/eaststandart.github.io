/**
 * @about Модуль лези-лоада видеоплееров.
 * @purpose Позволяет мгновенно открывать страницы проектов с демонстрационными `.webm` файлами без просадки производительности.
 * @author TechLab
 * @version 1.0.0
 */
