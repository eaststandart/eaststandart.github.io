    ...
    while i < len(lines):
        ...
        for group_line in group_lines:
            ...
            if raw_parts and raw_parts[0].strip('{} ').lower() == 'v':
                ...
                custom_attrs = f' width="{width}" height="{height}" style="aspect-ratio: {width} / {height} !important; --img-ratio: calc({width} / {height});"'
                raw_parts.pop(0)
        ...
        if is_image:
            ...
            for group_line in image_group_lines:
                ...
                if first_key.lower() == 'v':
                    ...
                    custom_attrs.append(f'style="aspect-ratio: {width} / {height} !important; --img-ratio: calc({width} / {height});"')
                    parts.pop(0)
