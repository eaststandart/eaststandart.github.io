...
> **Примечание:** Несимметричный мультивибратор – мультивибратор построенный на транзисторах разной проводимости. Принцип работы основан на том, что транзисторы одновременно, либо закрыты, либо открыты.

Устройство собрано на эргономичной деревянной рукоятке с ручным регулятором частоты. Для усиления звука ствол выполнен из пластиковой трубы, в которую интегрированы динамик  и блок из четырех светодиодов, мигающих в такт акустическим импульсам. Использование советских ретро-деталей в открытом монтаже придает бластеру уникальный футуристический образ.
...
> 2\. [Несимметричный генератор. Как это работает и несколько самоделок из него](https://yandex.ru/video/preview/2135205737810259244).\
...
### Развитие проекта
Добавление в схему лазерного модуля для подсветки цели или генерации ярких вспышек в такт частоте выстрелов бластера.
