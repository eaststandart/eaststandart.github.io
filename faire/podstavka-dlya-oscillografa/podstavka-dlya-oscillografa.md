...
Создание конструкции простой подставки для портативного осциллографа.

4. этот проект путь к созданию собственного исследователь оборуд и приспособлений, который явяется неотъем частью деятельности инженера-исследователя
