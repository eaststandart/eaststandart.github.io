---
layout: page
description: Развитие навыков конструирования шарнирного механизма, настройки ходовой части и работы с материалами при создании шагающей модели. Изучение принципов механики, преобразования вращательного движения в поступательное, а также основ электротехники при подключении мотор-редуктора.
...
4\. Разработка электронной автоматики поиска световых маяков для перехода между базовыми станциями в условиях темноты планеты.
