...
3\.  Изменить конструкцию поделки: в виде радуги на подставке, где цветовые полосы радуги будут подсвечиваться своим цветом светодиодов. Радугу сделать в виде, взлетающей по окружности, звезды.
