...
<!-- {% include pagination.liquid list_id="live-updates-list" controls_id="home-news-pagination" per_page=10 %} --> 

{% include pagination-next.liquid list_id="live-updates-list" controls_id="home-news-pagination" per_page=10 pinned_url="/people/fran-blanche/" %}
