        ...
        <div class="card-header">
            ...
            <div class="social-badge-wrapper">
                ...
                <a href="https://t.me" title="Телеграм-канал" class="social-badge-click">
                    <svg viewBox="0 0 24 24" width="30" height="30"><circle cx="12" cy="12" r="12" fill="#0088cc"/><path d="M17.5 7.7l-1.6 7.7c-.1.5-.4.6-.8.4l-2.5-1.8-1.2 1.2c-.1.1-.3.2-.5.2l.2-2.6 4.8-4.3c.2-.2 0-.3-.3-.1L10 11.3l-2.5-.8c-.5-.2-.6-.5.1-.8l9.9-3.8c.4-.2.8.1.7.8z" fill="#ffffff"/></svg>
                </a>
            </div>
        </div>
