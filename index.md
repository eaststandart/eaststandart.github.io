---
workflow: "добавить раздел 🗃️ типа картотеки (или значок), куда списком скинуть незадокументированные разделы - типа справочная, журнал, медиа и т.п."
layout: home
...
{% include pagination.liquid list_id="posts-list" controls_id="home-news-pagination" %}
