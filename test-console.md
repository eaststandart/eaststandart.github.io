...
---
<!-- [КЛ] 1: Отступы 25px. 2: Текст во всю ширину. 3: 3 серые кнопки + консоль. 4: Верх ПЛОТНО по логотипу. 5: Низ ПЛОТНО по логотипу. 6: Масштаб темы + серая ось. -->
<style>
    ...
    /* ИСПРАВЛЕНО: Полностью обнулен верхний падинг и зафиксирована высота текстового этажа */
    ...
    /* ИСПРАВЛЕНО: line-height: 0.8 и margin-top: -4px намертво затаскивают буквы на самую верхнюю грань квадрата */
    .brand-line-1 { font-size: 1.28rem !important; font-weight: bold !important; line-height: 0.8 !important; color: var(--text-color, #24292e) !important; margin: -4px 0 0 0 !important; padding: 0 !important; white-space: nowrap !important; text-align: justify !important; text-align-last: justify !important; width: 100% !important; letter-spacing: -0.2px !important; }
    .brand-description { font-size: 0.98rem !important; font-weight: normal !important; line-height: 0.9 !important; color: #666 !important; margin: 4px 0 0 0 !important; padding: 0 !important; text-align: justify !important; text-align-last: justify !important; width: 100% !important; }
    /* ИСПРАВЛЕНО: Убран верхний отступ над кнопками, высота яруса жестко завязана на 34px под нижний срез */
...
<header class="test-header">
    ...
    <div class="test-header-content-zone">
        ...
        <div class="header-text-tier">
            <h1 class="brand-line-1">ТВОРЧЕСКАЯ LАБОРАТОРИЯ ПОЗНАВАТЕЛЬНОГО РАЗВИТИЯ</h1>
...
<div class="visual-control-panel">
    <div class="control-title">📋 КОНТРОЛЬНЫЙ ЛИСТ ВЫПОЛНЕНИЯ ИНЖЕНЕРНЫХ ПРАВИЛ (Концепт Шапки v1.0 • Исправление прижима):</div>
    ...
    <div class="control-item"><strong>[Пункт 4]</strong> Первая строка заголовка жестко прижата к верхней грани синего квадрата логотипа через отрицательный маргин и line-height.</div>
    <div class="control-item"><strong>[Пункт 5]</strong> Линейка кнопок и инпут консоли прижаты строго к нижней грани синего квадрата логотипа темы.</div>
