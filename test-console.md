---
layout: default
title: Нативное выравнивание Концепта v1.0
---
<!-- [КЛ] 1: Отступы 25px. 2: Текст во всю ширину. 3: 3 серые кнопки + консоль. 4: Нативный верх по логотипу. 5: Нативный низ по логотипу. 6: Полное удаление искусственных смещений. -->
<style>
    ...
    /* ИСПРАВЛЕНО: Текстовый ярус больше не сжимается, отступы строго обнулены */
    ...
    /* ИСПРАВЛЕНО: УБРАНЫ ВСЕ СМЕЩЕНИЯ ДЛЯ BRAND-LINE. Включен line-height: 1.0 для идеальной нативной посадки */
...
<div class="visual-control-panel">
    <div class="control-title">📋 КОНТРОЛЬНЫЙ ЛИСТ ВЫПОЛНЕНИЯ ИНЖЕНЕРНЫХ ПРАВИЛ (Концепт Шапки v1.0 • Чистое выравнивание):</div>
    ...
    <div class="control-item"><strong>[Пункт 4]</strong> Первая строка заголовка нативно, без искусственных сдвигов, прижата к верхней линии зеленой зоны контента.</div>
    ...
    <div class="control-item"><strong>[Пункт 6]</strong> Масштаб логотипа не затрагивается. Тонкая серая ось делит контент ровно посередине аватара. Любые костыли translateY полностью удалены.</div>
</div>
