---
workflow: "Fritzing 1.0.5 (Retail version.).msi -недоступен надо что-то сделать на гитхаб много местазинимает"
layout: page
title: Fritzing
description: "Проектирование и документирование электронных схем, разводка печатных плат."
sources: "[Fritzing](https://fritzing.org/)"
keywords: [программноеобеспечение, software, электроника]
---

**Fritzing** – САПР (Система Автоматизированного Проектирования) для проектирования и документирования электронных схем, а также разводки печатных плат.
...
В программе спроектирована схема подключения светодиода (смотри фотографию), в которой измеряется сила электрического тока, протекающего через светодиод, и падение напряжения на нем (смотри файл [fritzing-led-sketch.fzz](files/fritzing-led-sketch.fzz). Для просмотра файла в Fritzing необходимо скачать файл [Fritzing 1.0.5 (Retail version.).msi](files/Fritzing 1.0.5 (Retail version.).msi) на компьютер и запустить его, а затем в программе открыть просматриваемый файл.
